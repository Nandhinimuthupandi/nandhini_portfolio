    ...
    return (
      <nav>
        <div className="nav_left">
          <h3>
            <span className="hi">Nandhini</span><span> M</span>
          </h3>
        </div>
        <div className="nav_right" id={open ? null : "hide"}>
          ...
          <h6>
            <Link
              ...
              onClick={closeMenu}
            >
              <MailIcon className="nav-icon" /> Contact
            </Link>
          </h6>
          <h6>
            <a
              className="resume"
              to="contact"
              href="https://drive.google.com/file/d/1wuY-oGw03jusFThmq66RNZrGDaQeJbP9/view?usp=sharing"
              target="_blank"
              rel="noreferrer"
              onClick={closeMenu}
            >
